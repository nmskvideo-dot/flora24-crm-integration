...
- [ ] Старые логи удаляются через 30 дней
- [ ] Встроенное редактирование Flora24 ID в списке товаров
- [ ] Метабокс Flora24 ID сохраняется на странице редактирования
- [ ] AJAX сохранение ID с визуальной обратной связью
